...
elseif(is_single()):
?>
<title><?php echo get_post_meta($post->ID, 'metaTitle', true);?>｜オンラインゲームPLANET</title>
...
<!-- ヘッダー -->
<header>
	<div class="ad-header"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/img_ad_header.jpg" width="100%" /></a></div>
